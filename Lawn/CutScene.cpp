...
void CutScene::StartLevelIntro()
{
	...
	if (mCrazyDaveTime <= 0 && mApp->mGameMode != GameMode::GAMEMODE_INTRO)
	{
		...
		else if (mApp->IsAdventureMode())
		{
			...
			else if (mBoard->mBackground == BackgroundType::BACKGROUND_7_FLOOD || mBoard->mBackground == BackgroundType::BACKGROUND_8_STORM)
			{
				aHouseMessage = TodStringTranslate(_S("[PLAYERS_ROOF]"));
			}
			else if (mBoard->mBackground == BackgroundType::BACKGROUND_9_HARD || mBoard->mBackground == BackgroundType::BACKGROUND_10_HARDNIGHT)
			{
				aHouseMessage = TodStringTranslate(_S("[PLAYERS_BACKYARD]"));
			}
			else
...
void CutScene::LoadIntroBoard()
{
	...
	mBoard->NewPlant(0, 1, SeedType::SEED_TWOPEATER, SeedType::SEED_NONE);
	mBoard->NewPlant(0, 2, SeedType::SEED_LILYPAD, SeedType::SEED_NONE);
	mBoard->NewPlant(0, 2, SeedType::SEED_SCAREDYSHROOM, SeedType::SEED_NONE);
	mBoard->NewPlant(0, 3, SeedType::SEED_LILYPAD, SeedType::SEED_NONE);
	mBoard->NewPlant(0, 3, SeedType::SEED_SCAREDYSHROOM, SeedType::SEED_NONE);
	mBoard->NewPlant(0, 4, SeedType::SEED_SUNFLOWER, SeedType::SEED_NONE);
	mBoard->NewPlant(1, 0, SeedType::SEED_TWOPEATER, SeedType::SEED_NONE);
	...
	mBoard->NewPlant(1, 4, SeedType::SEED_TWOPEATER, SeedType::SEED_NONE);
	mBoard->NewPlant(1, 5, SeedType::SEED_TWOPEATER, SeedType::SEED_NONE);
	mBoard->NewPlant(2, 0, SeedType::SEED_SUNFLOWER, SeedType::SEED_NONE);
	mBoard->NewPlant(2, 1, SeedType::SEED_SCAREDYSHROOM, SeedType::SEED_NONE);
	mBoard->NewPlant(2, 3, SeedType::SEED_LILYPAD, SeedType::SEED_NONE);
	mBoard->NewPlant(2, 3, SeedType::SEED_SCAREDYSHROOM, SeedType::SEED_NONE);
	...
	mBoard->NewPlant(3, 0, SeedType::SEED_WALLNUT, SeedType::SEED_NONE);
	mBoard->NewPlant(3, 4, SeedType::SEED_TWOPEATER, SeedType::SEED_NONE);
	mBoard->NewPlant(4, 2, SeedType::SEED_LILYPAD, SeedType::SEED_NONE);
	mBoard->NewPlant(4, 2, SeedType::SEED_WALLNUT, SeedType::SEED_NONE);
	mBoard->NewPlant(5, 1, SeedType::SEED_WALLNUT, SeedType::SEED_NONE);
	mBoard->NewPlant(5, 4, SeedType::SEED_WALLNUT, SeedType::SEED_NONE);
	mBoard->NewPlant(5, 5, SeedType::SEED_WALLNUT, SeedType::SEED_NONE);
