...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
    ...
    { ZOMBIE_DUCKY_TUBE,        REANIM_ZOMBIE,              1,      21,     1,      0,      _S("DUCKY_TUBE_ZOMBIE"),0 },
    ...
    { ZOMBIE_GARGANTUAR,        REANIM_GARGANTUAR,          10,     10,     1,      1500,   _S("GARGANTUAR"),0 },
    { ZOMBIE_IMP,               REANIM_IMP,                 10,     48,     1,      4000,      _S("IMP"),0 },
    { ZOMBIE_BOSS,              REANIM_BOSS,                10,     50,     1,      0,      _S("BOSS"),0 },
    { ZOMBIE_PEA_HEAD,          REANIM_ZOMBIE,              1,      51,     1,      4000,   _S("ZOMBIE_PEA_HEAD"), 1 },
    { ZOMBIE_WALLNUT_HEAD,      REANIM_ZOMBIE,              4,      51,     1,      3000,   _S("ZOMBIE_WALLNUT_HEAD"), 1 },
    { ZOMBIE_JALAPENO_HEAD,     REANIM_ZOMBIE,              3,      51,     10,     1000,   _S("ZOMBIE_JALAPENO_HEAD"), 1 },
    { ZOMBIE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      51,     10,     2000,   _S("ZOMBIE_GATLING_HEAD"), 1 },
...
void Zombie::PickRandomSpeed()
{
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT  || mZombieType == ZombieType::ZOMBIE_SNORKEL || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX)
    {
    ...
    {
        mVelX = RandRangeFloat(0.91f, 0.97f);
    }
    else
    {
        mVelX = RandRangeFloat(0.29f, 0.8f);
        if (mVelX < 0.3f)
        {
            mAnimTicksPerFrame = 12;
        }
