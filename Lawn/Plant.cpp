...
PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {  //0x69F2B0
    { SeedType::SEED_PEASHOOTER,        nullptr, ReanimationType::REANIM_REPEATER, 0, 100,     300,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("PEASHOOTER"),0 },
    { SeedType::SEED_SUNSHROOM,         nullptr, ReanimationType::REANIM_SUNSHROOM,     1,  50,     750,    PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("SUN_SHROOM"),0 },
    { SeedType::SEED_ICEBERGLETTUCE,         nullptr, ReanimationType::REANIM_SEASHROOM,     36, 0,     3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("ICEBERGLETTUCE"),0 },
    { SeedType::SEED_WALLNUT,           nullptr, ReanimationType::REANIM_WALLNUT,       2,  100,     3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("WALL_NUT"),0 },
    ...
    { SeedType::SEED_SLOWPEA,           nullptr, ReanimationType::REANIM_THREEPEATER,       4,  75,    1000,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SLOW_PEA"),0 },
    { SeedType::SEED_SCAREDYSHROOM,        nullptr, ReanimationType::REANIM_SCRAREYSHROOM,    33,  100,    750,    PlantSubClass::SUBCLASS_SHOOTER,    80,    _S("SCAREDY_SHROOM"),0 },
    ...
    { SeedType::SEED_TALLNUT,           nullptr, ReanimationType::REANIM_TALLNUT,       28, 125,    3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("TALL_NUT"),0 }, //Supposedly Giant Wallnut
    { SeedType::SEED_CHERRYBOMB,        nullptr, ReanimationType::REANIM_CHERRYBOMB,    3,  150,    3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("CHERRY_BOMB"),0 },
    { SeedType::SEED_LILYPAD,           nullptr, ReanimationType::REANIM_LILYPAD,       19, 25,     750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("LILY_PAD"),0 },
    { SeedType::SEED_SUNFLOWER,         nullptr, ReanimationType::REANIM_SUNFLOWER,     7,  50,     750,    PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("SUNFLOWER"),0 },
    { SeedType::SEED_FUMESHROOM,        nullptr, ReanimationType::REANIM_FUMESHROOM,    9,  125,     750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("FUME_SHROOM"),0 },
    ...
    { SeedType::SEED_REPEATER,          nullptr, ReanimationType::REANIM_REPEATER,      5,  200,    750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("REPEATER"),0 }, //Supposedly  Primal Wallnut
    ...
    { SeedType::SEED_TWINSUNFLOWER,     nullptr, ReanimationType::REANIM_TWIN_SUNFLOWER,1,  125,    1500,   PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("TWIN_SUNFLOWER"),0 }, //PALITAN into Twin SUnflower
    ...
    { SeedType::SEED_CACTUS,            nullptr, ReanimationType::REANIM_CACTUS,        15, 300,    1500,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("CACTUS"),0 },
    { SeedType::SEED_ICEBERGCABBAGE,    nullptr, ReanimationType::REANIM_CABBAGEPULT,   13, 225,    750,    PlantSubClass::SUBCLASS_SHOOTER,    300,    _S("ICEBERG_CABBAGE"),0 },
    ...
    { SeedType::SEED_GOLD_MAGNET,       nullptr, ReanimationType::REANIM_GOLD_MAGNET,   27, 50,     3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GOLD_MAGNET"),0 },
    { SeedType::SEED_SPIKEROCK,         nullptr, ReanimationType::REANIM_SPIKEROCK,     27, 250,    1500,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("SPIKEROCK"),0 },
    ...
    { SeedType::SEED_SNOWPEA,           nullptr, ReanimationType::REANIM_SNOWPEA,       44,  200,    500,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SNOW_PEA"),1 },
    { SeedType::SEED_STARFRUIT,         nullptr, ReanimationType::REANIM_STARFRUIT,     30, 175,    750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("STARFRUIT"),1 },
    { SeedType::SEED_SQUASH,            nullptr, ReanimationType::REANIM_SQUASH,        21, 50,     3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("SQUASH"),1 },
    { SeedType::SEED_HYPNOSHROOM,       nullptr, ReanimationType::REANIM_HYPNOSHROOM,   10, 75,     3000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("HYPNO_SHROOM"),1 },
    { SeedType::SEED_THREEPEATER,       nullptr, ReanimationType::REANIM_THREEPEATER,   12, 325,    750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("THREEPEATER"),1 },
    { SeedType::SEED_INSTANT_COFFEE,    nullptr, ReanimationType::REANIM_COFFEEBEAN,    33, 75,     750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("COFFEE_BEAN"),1 },
    { SeedType::SEED_CHOMPER,           nullptr, ReanimationType::REANIM_CHOMPER,       34, 150,    750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("CHOMPER"),1 }, //Nommer
    ...
    { SeedType::SEED_FIREPEASHOOTER,    nullptr, ReanimationType::REANIM_SNOWPEA,       4,  250,    500,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("FIREPEASHOOTER"),1 },
...
void Plant::UpdateSpikeweed()
{
    ...
    if (mState == PlantState::STATE_SPIKEWEED_ATTACKING)
    {
        ...
        else if (mSeedType == SeedType::SEED_SPIKEROCK || mSeedType == SeedType::SEED_SPIKERUSH)
        {
...
//0x4607E0
Zombie* Plant::FindVeryNearestTarget()
{
    int aDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
    Rect aAttackRect = GetPlantAttackRect(PlantWeapon::WEAPON_PRIMARY);
...
Reanimation* Plant::AttachBlinkAnim(Reanimation* theReanimBody)
{
    ...
    if (mSeedType == SeedType::SEED_WALLNUT || mSeedType == SeedType::SEED_TALLNUT || mSeedType == SeedType::SEED_BASILISK ||
    ...
    else if (mSeedType == SeedType::SEED_PEASHOOTER ||
        mSeedType == SeedType::SEED_NOMMER ||
        mSeedType == SeedType::SEED_SNOWPEA ||
        mSeedType == SeedType::SEED_FIREPEASHOOTER ||
        mSeedType == SeedType::SEED_SLOWPEA ||
...
void Plant::UpdateShooting()
{
    ...
    else if (mShootingCounter == 1)
    {
        ...
        }if (mSeedType == SeedType::SEED_NOMMER)
        {
            int rowAbove = mRow - 1;
            int rowBelow = mRow + 1;
            Reanimation* aHeadReanim2 = mApp->ReanimationGet(mHeadReanimID2);
        ...
        else if (mState == PlantState::STATE_CACTUS_LOW)
        {
            ...
            mSeedType == SeedType::SEED_ICEBERGCABBAGE ||
...
void Plant::Animate()
{
    ...
    if (mSeedType == SeedType::SEED_WALLNUT || mSeedType == SeedType::SEED_BASILISK
        || mSeedType == SeedType::SEED_TALLNUT || mSeedType == SeedType::SEED_EXPLODE_O_NUT)
    {
        AnimateNuts();
    }
...
void Plant::BlowAwayFliers(int theX, int theRow)
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if (!aZombie->IsDeadOrDying())
        {
            ...
            if (aZombie->mRow == mRow && aZombie->EffectedByDamage(GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY))) {
                aZombie->ApplyChill(true);
                if (aZombie->IsFlying())
                {
...
void Plant::DoSpecial()
{
    ...
    case SeedType::SEED_ICEBERGLETTUCE:
    {
        ...
        mApp->PlayFoley(FoleyType::FOLEY_FROZEN);
        mBoard->IceAllZombiesInRadius(mRow, aPosX, aPosY, 60, 1, true, aDamageRangeFlags);
...
void Plant::Fire(Zombie* theTargetZombie, int theRow, PlantWeapon thePlantWeapon)
{
    ...
    case SeedType::SEED_SNOWPEA:
        ...
        break;
    case SeedType::SEED_SLOWPEA:
        aProjectileType = ProjectileType::PROJECTILE_SLOWPEA;
        break;
    case SeedType::SEED_SOULPEA:
    ...
    else if (mSeedType == SeedType::SEED_CABBAGEPULT || mSeedType == SeedType::SEED_ICEBERGCABBAGE)
    {
        aOriginX = mX + 5;
        aOriginY = mY - 12;
    }
    ...
    else if (mSeedType == SeedType::SEED_SPLITPEA)
    {
        ...
        mSeedType == SeedType::SEED_TWOPEATER)
    {
        aOriginX = mX + 45;
        aOriginY = mY + 10;
    }
    ...
    if (mSeedType == SeedType::SEED_CABBAGEPULT || mSeedType == SeedType::SEED_KERNELPULT || mSeedType == SeedType::SEED_ICEBERGCABBAGE ||
    ...
    else if (mSeedType == SeedType::SEED_PUFFSHROOM || mSeedType == SeedType::SEED_SEASHROOM || mSeedType == SeedType::SEED_NOMMER)
    {
...
Zombie* Plant::FindTargetZombie(int theRow, PlantWeapon thePlantWeapon)
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        ...
        {
            if (mSeedType == SeedType::SEED_POTATOMINE || mSeedType == SeedType::SEED_CHOMPER || mSeedType == SeedType::SEED_ICEBERGLETTUCE || mSeedType == SeedType::SEED_TANGLEKELP)
            {
                continue;
            }
        }
        ...
        if (aZombie->EffectedByDamage(aDamageRangeFlags))
        {
            ...
            if (mSeedType == SeedType::SEED_POTATOMINE || mSeedType == SeedType::SEED_ICEBERGLETTUCE)
            {
...
Rect Plant::GetPlantAttackRect(PlantWeapon thePlantWeapon)
{
    ...
    case SeedType::SEED_NOMMER:         aRect = Rect(mX + 60,       mY,             120,                mHeight);               break;
    case SeedType::SEED_PUFFSHROOM:
